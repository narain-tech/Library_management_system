...
{
    cn.Open();
    cmd= new SqlCommand ("insert into returnbook(studentid,studentname,fathername,course,branch,year,semester,bookid,bookname,edition,publisher,price,stock,dateofissue,returndate) values('"+StudentIDTextBox.Text+"','"+StudentNameTextBox.Text+"','"+FathersNameTextBox.Text+"','"+CourseTextBox.Text+"','"+BranchTextBox.Text+"','"+YearTextBox.Text+"','"+SemesterTextBox.Text+"','"+BookIDTextBox.Text+"','"+BooknameTextBox.Text+"','"+EditionTextBox.Text+"','"+PublisherTextBox.Text+"','"+PriceTextBox.Text+"','"+StockTextBox.Text+"','"+DateOfIssueTextBox.Text+"','"+ReturnDateTextBox.Text+"')",cn);
    cmd.ExecuteNonQuery();
